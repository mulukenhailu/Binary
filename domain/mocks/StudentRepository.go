...
func (_m *StudentRepository) Create(c context.Context, createStudentDto *domain.CreateStudentDto) error {
...
func (_m *StudentRepository) Delete(c context.Context, studentInformationId int32) error {
...
func (_m *StudentRepository) FetchByStudentId(c context.Context, studentId string) (domain.Student, error) {
...
func (_m *StudentRepository) FetchStudents(c context.Context) ([]domain.Student, error) {
	ret := _m.Called(c)
...
func (_m *StudentRepository) Update(c context.Context, updateStudentDto *domain.UpdateStudentDto) error {
