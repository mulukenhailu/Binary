...
func (_m *DeviceRepository) Create(c context.Context, device *domain.CreateDeviceDto) error {
...
func (_m *DeviceRepository) Delete(c context.Context, deviceId int32) error {
...
func (_m *DeviceRepository) FetchByCampus(c context.Context, campusName string) ([]domain.Device, error) {
...
func (_m *DeviceRepository) FetchDevices(c context.Context) ([]domain.Device, error) {
	ret := _m.Called(c)
...
func (_m *DeviceRepository) Update(c context.Context, updateDeviceDto *domain.UpdateDeviceDto) error {
