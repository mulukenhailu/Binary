...
func (_m *RolePermissionRepository) Create(c context.Context, createPermission *domain.CreatePermissionDto) error {
...
func (_m *RolePermissionRepository) Delete(c context.Context, roleId int32) error {
...
func (_m *RolePermissionRepository) FetchByPermissionId(c context.Context, permissionId int32) ([]domain.RolePermission, error) {
...
func (_m *RolePermissionRepository) FetchByRoleId(c context.Context, roleId int32) ([]domain.RolePermission, error) {
	ret := _m.Called(c, roleId)
...
func (_m *RolePermissionRepository) FetchRolePermissions(c context.Context) ([]domain.RolePermission, error) {
	ret := _m.Called(c)
...
func (_m *RolePermissionRepository) Update(c context.Context, updatePermission *domain.UpdatePermissionDto) error {
